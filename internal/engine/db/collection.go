...
type Collection interface {
	...
	UpdateOne(ctx context.Context, filter interface{}, update interface{}, options *options.UpdateOptions) (modified int64, error error)
...
func (m *mongoCollection) UpdateOne(ctx context.Context, filter interface{}, update interface{}, options *options.UpdateOptions) (modified int64, error error) {
	insertedId, err := m.collection.UpdateOne(context.Background(), filter, update, options)
	if err != nil {
		return 0, err
	}
